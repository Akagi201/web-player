  ...
  this.push = function (packet) {
    ...
    while (i + 5 < buffer.length) {
      ...
      this.trigger('data', {
        ...
        channelcount: (buffer[i + 2] & 1) << 3 | (buffer[i + 3] & 0xc0) >>> 6,
...
H264Stream = function () {
  ...
  readSequenceParameterSet = function (data) {
    ...
    if (profileIdc === 100 || profileIdc === 110 || profileIdc === 122 || profileIdc === 244 || profileIdc === 44 || profileIdc === 83 || profileIdc === 86 || profileIdc === 118 || profileIdc === 128 || profileIdc === 138 || profileIdc === 139 || profileIdc === 134) {
...
var MetadataStream, Transmuxer, VideoSegmentStream, AudioSegmentStream, CoalesceStream, collectTimelineInfo, metaDataTag, extraDataTag;
...
Transmuxer = function (options) {
  ...
  elementaryStream.pipe(adtsStream);

  elementaryStream.pipe(this.metadataStream).pipe(coalesceStream);
  ...
  this.getFlvHeader = function (duration, audio, video) {
    // :ByteArray {
...
// object types
var TransportPacketStream, TransportParseStream, ElementaryStream, AacStream, H264Stream, NalByteStream;
 ...
 * Stream packets.
 */
TransportPacketStream = function TransportPacketStream() {
...
var box, dinf, esds, ftyp, mdat, mfhd, minf, moof, moov, mvex, mvhd, trak, tkhd, mdia, mdhd, hdlr, sdtp, stbl, stsd, styp, traf, trex, trun, types, MAJOR_BRAND, MINOR_VERSION, AVC1_BRAND, VIDEO_HDLR, AUDIO_HDLR, HDLR_TYPES, VMHD, SMHD, DREF, STCO, STSC, STSZ, STTS;
...
traf = function (track) {
  ...
  trackFragmentDecodeTime = box(types.tfdt, new Uint8Array([0x00, // version 0
  0x00, 0x00, 0x00, // flags
  // baseMediaDecodeTime
  track.baseMediaDecodeTime >>> 24 & 0xFF, track.baseMediaDecodeTime >>> 16 & 0xFF, track.baseMediaDecodeTime >>> 8 & 0xFF, track.baseMediaDecodeTime & 0xFF]));
...
Transmuxer = function (options) {
  ...
  this.setupTsPipeline = function () {
    ...
    pipeline.elementaryStream.pipe(pipeline.metadataStream).pipe(pipeline.coalesceStream);
...
var tagTypes = {
  ...
  var avcPacketTypes = ['AVC Sequence Header', 'AVC NALU', 'AVC End-of-Sequence'],
      nalUnitTypes = ['unspecified', 'slice_layer_without_partitioning', 'slice_data_partition_a_layer', 'slice_data_partition_b_layer', 'slice_data_partition_c_layer', 'slice_layer_without_partitioning_idr', 'sei', 'seq_parameter_set', 'pic_parameter_set', 'access_unit_delimiter', 'end_of_seq', 'end_of_stream', 'filler', 'seq_parameter_set_ext', 'prefix_nal_unit', 'subset_seq_parameter_set', 'reserved', 'reserved', 'reserved'],
  ...
  var frameTypes = ['Unknown', 'Keyframe (for AVC, a seekable frame)', 'Inter frame (for AVC, a nonseekable frame)', 'Disposable inter frame (H.263 only)', 'Generated keyframe (reserved for server use only)', 'Video info/command frame'],
      codecIDs = ['JPEG (currently unused)', 'Sorenson H.263', 'Screen video', 'On2 VP6', 'On2 VP6 with alpha channel', 'Screen video version 2', 'AVC'],
...
},{"./codec-utils":25,"./flash-constants":27,"./flash-source-buffer":29}],29:[function(require,module,exports){
(function (global){
/**
...
},{"./add-text-track-data":24,"./create-text-tracks-if-necessary":26,"./flash-constants":27,"./remove-cues-from-track":31,"mux.js":8}],30:[function(require,module,exports){
(function (global){
/**
...
},{"./codec-utils":25,"./virtual-source-buffer":34}],31:[function(require,module,exports){
/**
...
},{"mux.js":8}],33:[function(require,module,exports){
(function (global){
/**
...
},{"./flash-media-source":28,"./html-media-source":30}],34:[function(require,module,exports){
(function (global){
/**
...
},{"./add-text-track-data":24,"./codec-utils":25,"./create-text-tracks-if-necessary":26,"./remove-cues-from-track":31,"./transmuxer-worker":32,"webworkify":23}],35:[function(require,module,exports){
(function (global){
'use strict';
...
_qunit2['default'].test('delegates to the native implementation', function () {
  _qunit2['default'].ok(!/blob:vjs-media-source\//.test(_videoJs2['default'].URL.createObjectURL(new Blob())), 'created a native blob URL');
});
...
},{"../src/flash-media-source":28,"../src/html-media-source":30,"../src/videojs-contrib-media-sources.js":33,"global/document":22}],36:[function(require,module,exports){
(function (global){
'use strict';
...
var MockSegmentParser = function MockSegmentParser() {
  var ons = {};
  var datas = [];
...
_qunit2['default'].module('Flash MediaSource', {
  beforeEach: function beforeEach(assert) {
    ...
    this.Flash = _videoJs2['default'].getComponent('Flash');
    ...
    this.oldBPS = _srcFlashMediaSource2['default'].BYTES_PER_SECOND_GOAL;
    this.oldFlashTransmuxer = _muxJs2['default'].flv.Transmuxer;
    _muxJs2['default'].flv.Transmuxer = MockSegmentParser;
    ...
    swfObj.CallFunction = function (xml) {
      ...
      _this.swfCalls.push(call);
    };
    /* eslint-disable camelcase */
    swfObj.vjs_abort = function () {
      _this.swfCalls.push('abort');
    };
    swfObj.vjs_getProperty = function (attr) {
      ...
      _this.swfCalls.push({ attr: attr });
    };
    swfObj.vjs_load = function () {
      _this.swfCalls.push('load');
    };
    swfObj.vjs_setProperty = function (attr, value) {
      _this.swfCalls.push({ attr: attr, value: value });
    };
  ...
  afterEach: function afterEach() {
    ...
    _srcFlashMediaSource2['default'].BYTES_PER_SECOND_GOAL = this.oldBPS;
    _muxJs2['default'].flv.Transmuxer = this.oldFlashTransmuxer;
    this.player.dispose();
    this.clock.restore();
    this.swfCalls = [];
    unfakeSTO();
...
_qunit2['default'].test('passes bytes to Flash', function () {
  ...
  this.swfCalls = appendCalls(this.swfCalls);
  _qunit2['default'].strictEqual(this.swfCalls[0].callee, 'vjs_appendBuffer', 'called appendBuffer');
  _qunit2['default'].deepEqual(this.swfCalls[0].arguments[0], [0, 1], 'passed the base64 encoded data');
});

_qunit2['default'].test('size of the append window changes based on timing information', function () {
  var sourceBuffer = this.mediaSource.addSourceBuffer('video/mp2t');
  var time = 0;
  var oldDate = Date;
  var swfObj = this.mediaSource.swfObj;
  var callFunction = swfObj.CallFunction;
  // Set some easy-to-test values
  var BYTES_PER_CHUNK = _srcFlashConstants2['default'].BYTES_PER_CHUNK;
  var MIN_CHUNK = _srcFlashConstants2['default'].MIN_CHUNK;
  var MAX_CHUNK = _srcFlashConstants2['default'].MAX_CHUNK;

  _srcFlashConstants2['default'].BYTES_PER_CHUNK = 2;
  _srcFlashConstants2['default'].MIN_CHUNK = 1;
  _srcFlashConstants2['default'].MAX_CHUNK = 10;
  ...
  _qunit2['default'].equal(this.swfCalls.shift().indexOf('load'), 0, 'swf load called');
  _qunit2['default'].equal(this.swfCalls.length, 8, 'called swf once per two-bytes');
  _qunit2['default'].equal(sourceBuffer.chunkSize_, 4, 'sourceBuffer.chunkSize_ doubled');
  ...
  _qunit2['default'].equal(this.swfCalls.length, 8, 'called swf once per byte');
  _qunit2['default'].equal(this.swfCalls[0].arguments[0].length, 4, 'swf called with 4 bytes');
  _qunit2['default'].equal(this.swfCalls[1].arguments[0].length, 4, 'swf called with 4 bytes twice');
  _qunit2['default'].equal(this.swfCalls[2].arguments[0].length, 2, 'swf called with 2 bytes');
  _qunit2['default'].equal(this.swfCalls[3].arguments[0].length, 2, 'swf called with 2 bytes twice');
  _qunit2['default'].equal(this.swfCalls[4].arguments[0].length, 1, 'swf called with 1 bytes');
  _qunit2['default'].equal(this.swfCalls[5].arguments[0].length, 1, 'swf called with 1 bytes twice');
  _qunit2['default'].equal(this.swfCalls[6].arguments[0].length, 1, 'swf called with 1 bytes thrice');
  _qunit2['default'].equal(this.swfCalls[7].arguments[0].length, 1, 'swf called with 1 bytes four times');
  _qunit2['default'].equal(sourceBuffer.chunkSize_, 1, 'sourceBuffer.chunkSize_ reduced to 1');

  _srcFlashConstants2['default'].BYTES_PER_CHUNK = BYTES_PER_CHUNK;
  _srcFlashConstants2['default'].MIN_CHUNK = MIN_CHUNK;
  _srcFlashConstants2['default'].MAX_CHUNK = MAX_CHUNK;
  /* eslint-disable no-native-reassign */
  /* eslint-disable no-undef */
  Date = oldDate;
  /* eslint-disable no-native-reassign */
...
_qunit2['default'].test('drops tags before currentTime when seeking', function () {
  ...
  // starting PTS value
  while (i--) {
    tags_.unshift(makeFlvTag(i * 1000 + 29 * 1000, new Uint8Array([i])));
  }
  sourceBuffer.segmentParser_.trigger('data', {
    tags: {
      videoTags: tags_,
...
_qunit2['default'].test('drops tags before the buffered end always', function () {
  var sourceBuffer = this.mediaSource.addSourceBuffer('video/mp2t');
  var i = 10;
...
_qunit2['default'].test('seek targeting accounts for changing timestampOffsets', function () {
  ...
  while (i--) {
    ...
    makeFlvTag(i * 1000 + 101 * 1000, new Uint8Array([i + sourceBuffer.timestampOffset])));
  }
  sourceBuffer.segmentParser_.trigger('data', {
    tags: {
      videoTags: tags_,
  ...
  _qunit2['default'].deepEqual(this.swfCalls[0].arguments[0], [26, 27, 28, 29, 30, 31], 'filtered the appended tags');
});
...
_qunit2['default'].test('calling endOfStream sets mediaSource readyState to ended', function () {
  ...
  this.mediaSource.swfObj.vjs_endOfStream = function () {
    _this2.swfCalls.push('endOfStream');
  };
  /* eslint-enable camelcase */
  ...
  _qunit2['default'].strictEqual(sourceBuffer.mediaSource.readyState, 'ended', 'readyState is \'ended\'');
...
_qunit2['default'].test('opens the stream on sourceBuffer.appendBuffer after endOfStream', function () {
  ...
  _qunit2['default'].strictEqual(this.swfCalls.length, 2, 'made two appends');
  _qunit2['default'].deepEqual(this.swfCalls.shift().arguments[0], [2], 'contains the third byte');
  _qunit2['default'].deepEqual(this.swfCalls.shift().arguments[0], [3], 'contains the fourth byte');
  _qunit2['default'].strictEqual(sourceBuffer.mediaSource.readyState, 'open', 'The streams should be open if more bytes are appended to an "ended" stream');
  _qunit2['default'].strictEqual(timers.length, 0, 'no more appends are scheduled');
});
...
_qunit2['default'].test('does not use requestAnimationFrame', function () {
  var oldRFA = window.requestAnimationFrame;
  var requests = 0;
  var sourceBuffer = undefined;
...
_qunit2['default'].test('throws an error if append is called while updating', function () {
  ...
  _qunit2['default'].throws(function () {
    ...
    return e.name === 'InvalidStateError' && e.code === window.DOMException.INVALID_STATE_ERR;
...
_qunit2['default'].test('calculates the base PTS for the media', function () {
  ...
  makeFlvTag((10 + 3) * 90000, new Uint8Array([10])), makeFlvTag((15 + 3) * 90000, new Uint8Array([15])));
...
_qunit2['default'].test('flushes the transmuxer after each append', function () {
  var sourceBuffer = this.mediaSource.addSourceBuffer('video/mp2t');
  var flushes = 0;
  ...
  sourceBuffer.appendBuffer(new Uint8Array([0, 1]));
  timers.pop()();
  _qunit2['default'].equal(flushes, 1, 'flushed the transmuxer');
});
...
},{"../src/flash-constants":27,"../src/flash-media-source":28,"../src/flash-source-buffer":29,"../src/videojs-contrib-media-sources.js":33,"global/document":22,"mux.js":8}],37:[function(require,module,exports){
(function (global){
'use strict';
...
_qunit2['default'].module('videojs-contrib-media-sources - HTML', {
  beforeEach: function beforeEach() {
    ...
    this.clock = _sinon2['default'].useFakeTimers();
    this.oldMediaSource = window.MediaSource || window.WebKitMediaSource;
    window.MediaSource = _videoJs2['default'].extend(_videoJs2['default'].EventTarget, {
...
_qunit2['default'].test('calling remove deletes cues and invokes remove on any extant source buffers', function () {
  ...
  _qunit2['default'].equal(sourceBuffer.inbandTextTrack_.cues.length, 1, 'one cue remains after remove');
...
_qunit2['default'].test('translates caption events into WebVTT cues', function () {
  ...
  mediaSource.player_ = {
    addTextTrack: function addTextTrack(type) {
      types.push(type);
      return {
  ...
  _qunit2['default'].equal(cues[0].text, 'This is an in-band caption', 'included the text');
...
_qunit2['default'].test('translates metadata events into WebVTT cues', function () {
  ...
  _qunit2['default'].equal(cues[0].endTime, 12, 'ended at twelve');
  ...
  _qunit2['default'].equal(cues[1].endTime, 12, 'ended at twelve');
  ...
  _qunit2['default'].equal(cues[2].endTime, 22, 'ended at twenty two');
});
...
},{"../src/html-media-source":30,"../src/videojs-contrib-media-sources.js":33,"global/document":22}]},{},[35,36,37]);
