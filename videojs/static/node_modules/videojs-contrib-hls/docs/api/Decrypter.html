...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Decrypter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Decrypter</h1>
...
<article>
    ...
    <h4 class="name" id="Decrypter"><span class="type-signature"></span>new Decrypter<span class="signature">(encrypted, key, initVector, done)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Uint8Array</span>
            ...
            <td class="description last">the encrypted bytes</td>
        </tr>
...
<span class="param-type">Uint32Array</span>
            ...
            <td class="description last">the bytes of the decryption key</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>initVector</code></td>
...
<span class="param-type">Uint32Array</span>
            ...
            <td class="description last">the initialization vector (IV) to</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">the function to run when done</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="decrypter_decrypter.js.html">decrypter/decrypter.js</a>, <a href="decrypter_decrypter.js.html#line104">line 104</a>
    </li></ul></dd>
...
<h4 class="name" id=".STEP"><span class="type-signature">(static) </span>STEP<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="decrypter_decrypter.js.html">decrypter/decrypter.js</a>, <a href="decrypter_decrypter.js.html#line151">line 151</a>
    </li></ul></dd>
