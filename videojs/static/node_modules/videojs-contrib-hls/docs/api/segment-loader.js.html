...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: segment-loader.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: segment-loader.js</h1>
...
export default class SegmentLoader extends videojs.EventTarget {
  ...
  checkBuffer_(buffered, playlist, currentTime) {
    ...
    // Return if this segment was already requested twice in the last 5 requests
    if (this.requestHistory_.filter((req)=>req === segment.resolvedUri).length >= 2) {
      return null;
    }

    // Store the URIs of the last 5 segments we have requested
    this.requestHistory_.unshift(segment.resolvedUri);
    this.requestHistory_.length = 5;
